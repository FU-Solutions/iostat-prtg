...
<meta content="iostat · master · DG Ullrich Weichert / iostat-prtg" property="og:title">
...
<meta content="https://git.corbox-engine.lan/adm_uweichert/iostat-prtg/-/blob/master/iostat" property="og:url">
<meta content="summary" property="twitter:card">
<meta content="iostat · master · DG Ullrich Weichert / iostat-prtg" property="twitter:title">
...
<title>iostat · master · DG Ullrich Weichert / iostat-prtg · GitLab</title>
...
<meta name="csrf-token" content="eEszjIiPJ6dQRT5FYbooDuXVMvacX/4O88vxPoFGjoUrtfMxzcrhVnQ/tObCbx0MYH6UmPxzyYxHVtNa7xkILg==" />
<meta name="csp-nonce" />
...
<body class="ui-indigo tab-width-8  gl-browser-edge gl-platform-windows" data-find-file="/adm_uweichert/iostat-prtg/-/find_file/master" data-namespace-id="9" data-page="projects:blob:show" data-page-type-id="master/iostat" data-project="iostat-prtg" data-project-id="36">
...
<input type="hidden" name="path" id="path" value="iostat" />
<div class="dropdown">
...
<li class="breadcrumb-item">
<a href="/adm_uweichert/iostat-prtg/-/blob/master/iostat"><strong>iostat</strong>
</a></li>
</ul>
</div>
...
</a><a class="gl-button btn btn-default js-blob-blame-link" href="/adm_uweichert/iostat-prtg/-/blame/master/iostat">Blame</a><a class="gl-button btn btn-default" href="/adm_uweichert/iostat-prtg/-/commits/master/iostat">History</a><a class="gl-button btn btn-default js-data-file-blob-permalink-url" href="/adm_uweichert/iostat-prtg/-/blob/28012ea80b5eea458c9d28f547d63ce82b7577a1/iostat">Permalink</a></div>
</div>
...
<button class="btn gl-button btn btn-default-tertiary btn-icon btn-sm" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="gl-button btn btn-default-tertiary btn-icon btn-sm" data-title="Copy file path" data-clipboard-text="{&quot;text&quot;:&quot;iostat&quot;,&quot;gfm&quot;:&quot;`iostat`&quot;}" type="button" title="Copy file path" aria-label="Copy file path"><svg class="s16" data-testid="copy-to-clipboard-icon"><use xlink:href="/assets/icons-a53822592d2fb2cd30ac129d53a7440a8aa3ffcd0bd43075602941d95b629b76.svg#copy-to-clipboard"></use></svg></button>
<small class="mr-1">
136 Bytes
</small>
</div>

<div class="file-actions gl-display-flex gl-align-items-center gl-flex-wrap gl-md-justify-content-end"><a class="btn gl-button btn-confirm js-edit-blob gl-ml-3 " data-track-event="click_edit" data-track-label="Edit" href="/adm_uweichert/iostat-prtg/-/edit/master/iostat">Edit</a><a class="btn gl-button btn-confirm ide-edit-button gl-ml-3 btn-inverted" data-track-event="click_edit_ide" data-track-label="Web IDE" data-track-property="secondary" href="/-/ide/project/adm_uweichert/iostat-prtg/edit/master/-/iostat">Web IDE</a><div class="btn-group gl-ml-3" role="group">
...
<button class="btn btn gl-button btn-default btn-icon js-copy-blob-source-btn" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="btn gl-button btn-default btn-icon js-copy-blob-source-btn" data-title="Copy file contents" data-clipboard-target=".blob-content[data-blob-id=&#39;fe8f00fd536fbbe72bd1b6c9bbdba2a177ec83b8&#39;] &gt; pre" type="button" title="Copy file contents" aria-label="Copy file contents"><svg class="s16" data-testid="copy-to-clipboard-icon"><use xlink:href="/assets/icons-a53822592d2fb2cd30ac129d53a7440a8aa3ffcd0bd43075602941d95b629b76.svg#copy-to-clipboard"></use></svg></button>
<a class="btn gl-button btn-default btn-icon has-tooltip" target="_blank" rel="noopener noreferrer" aria-label="Open raw" title="Open raw" data-container="body" href="/adm_uweichert/iostat-prtg/-/raw/master/iostat"><svg class="s16" data-testid="doc-code-icon"><use xlink:href="/assets/icons-a53822592d2fb2cd30ac129d53a7440a8aa3ffcd0bd43075602941d95b629b76.svg#doc-code"></use></svg></a>
<a download="iostat" class="btn gl-button btn-default btn-icon has-tooltip" target="_blank" rel="noopener noreferrer" aria-label="Download" title="Download" data-container="body" href="/adm_uweichert/iostat-prtg/-/raw/master/iostat?inline=false"><svg class="s16" data-testid="download-icon"><use xlink:href="/assets/icons-a53822592d2fb2cd30ac129d53a7440a8aa3ffcd0bd43075602941d95b629b76.svg#download"></use></svg></a>
...
<a class="js-fork-suggestion-button gl-button btn btn-grouped btn-inverted btn-success" rel="nofollow" data-method="post" href="/adm_uweichert/iostat-prtg/-/blob/master/iostat">Fork</a>
...
<div class="blob-viewer" data-path="iostat" data-type="simple" data-url="/adm_uweichert/iostat-prtg/-/blob/master/iostat?format=json&amp;viewer=simple">
...
<h3 class="page-title">Delete iostat</h3>
<button aria-label="Close" class="close" data-dismiss="modal" type="button">
<span aria-hidden>&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-delete-blob-form js-quick-submit js-requires-input" action="/adm_uweichert/iostat-prtg/-/blob/master/iostat" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="delete" /><input type="hidden" name="authenticity_token" value="1rdxflhnhIGu8toLQZWzctKjkFGmYOB5LZf6DYGULD2FSbHDHSJCcIqIUKjiQIZwVwg2P8ZM1/uZCthp78uqlg==" /><div class="form-group row commit_message-group">
<label class="col-form-label col-sm-2" for="commit_message-35666b67fb276050958309963ea33615">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-35666b67fb276050958309963ea33615" class="form-control gl-form-input js-commit-message" placeholder="Delete iostat" required="required" rows="3">
Delete iostat</textarea>
</div>
</div>
</div>
...
<input type="checkbox" name="create_merge_request" id="create_merge_request-56cde15a49f5760a83453d83f65c05cf" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-56cde15a49f5760a83453d83f65c05cf">Start a <strong>new merge request</strong> with these changes
</label></div>
...
<div class="modal-content">
<div class="modal-header">
<h3 class="page-title">Replace iostat</h3>
<button aria-label="Close" class="close" data-dismiss="modal" type="button">
<span aria-hidden>&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-quick-submit js-upload-blob-form" data-method="put" action="/adm_uweichert/iostat-prtg/-/update/master/iostat" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="put" /><input type="hidden" name="authenticity_token" value="3mzPsvCuBDfpdwU7AB7HviC4b1hJCeW47w7PQ+RMKbiNkg8PtevCxs0Nj5ijy/K8pRPJNikl0jpbk+0nihOvEw==" /><div class="dropzone">
...
<label class="col-form-label col-sm-2" for="commit_message-0424b2bc433ee146f662c074c967bacf">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-0424b2bc433ee146f662c074c967bacf" class="form-control gl-form-input js-commit-message" placeholder="Replace iostat" required="required" rows="3">
Replace iostat</textarea>
</div>
</div>
</div>
...
<div class="js-create-merge-request-container">
<div class="form-check gl-mt-3">
<input type="checkbox" name="create_merge_request" id="create_merge_request-bd9a7f49d8a54e94133c5ecfbd6b21bc" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-bd9a7f49d8a54e94133c5ecfbd6b21bc">Start a <strong>new merge request</strong> with these changes
</label></div>
