...
<meta content="iostat-parse.sh · master · DG Ullrich Weichert / iostat-prtg" property="og:title">
...
<meta content="https://git.corbox-engine.lan/adm_uweichert/iostat-prtg/-/blob/master/iostat-parse.sh" property="og:url">
<meta content="summary" property="twitter:card">
<meta content="iostat-parse.sh · master · DG Ullrich Weichert / iostat-prtg" property="twitter:title">
...
<title>iostat-parse.sh · master · DG Ullrich Weichert / iostat-prtg · GitLab</title>
...
<meta name="csrf-token" content="8lPGHw+VtuOIAYXl8kl7imYhDrisDGGlwIRqFTiB67uhrQaiStBwEqx7D0ZRnE6I44qo1swgVid0GUhxVt5tEA==" />
<meta name="csp-nonce" />
...
<body class="ui-indigo tab-width-8  gl-browser-edge gl-platform-windows" data-find-file="/adm_uweichert/iostat-prtg/-/find_file/master" data-namespace-id="9" data-page="projects:blob:show" data-page-type-id="master/iostat-parse.sh" data-project="iostat-prtg" data-project-id="36">
...
<input type="hidden" name="path" id="path" value="iostat-parse.sh" />
<div class="dropdown">
...
<li class="breadcrumb-item">
<a href="/adm_uweichert/iostat-prtg/-/blob/master/iostat-parse.sh"><strong>iostat-parse.sh</strong>
</a></li>
</ul>
</div>
...
</a><a class="gl-button btn btn-default js-blob-blame-link" href="/adm_uweichert/iostat-prtg/-/blame/master/iostat-parse.sh">Blame</a><a class="gl-button btn btn-default" href="/adm_uweichert/iostat-prtg/-/commits/master/iostat-parse.sh">History</a><a class="gl-button btn btn-default js-data-file-blob-permalink-url" href="/adm_uweichert/iostat-prtg/-/blob/28012ea80b5eea458c9d28f547d63ce82b7577a1/iostat-parse.sh">Permalink</a></div>
</div>
...
<button class="btn gl-button btn btn-default-tertiary btn-icon btn-sm" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="gl-button btn btn-default-tertiary btn-icon btn-sm" data-title="Copy file path" data-clipboard-text="{&quot;text&quot;:&quot;iostat-parse.sh&quot;,&quot;gfm&quot;:&quot;`iostat-parse.sh`&quot;}" type="button" title="Copy file path" aria-label="Copy file path"><svg class="s16" data-testid="copy-to-clipboard-icon"><use xlink:href="/assets/icons-a53822592d2fb2cd30ac129d53a7440a8aa3ffcd0bd43075602941d95b629b76.svg#copy-to-clipboard"></use></svg></button>
<small class="mr-1">
1008 Bytes
</small>
</div>

<div class="file-actions gl-display-flex gl-align-items-center gl-flex-wrap gl-md-justify-content-end"><a class="btn gl-button btn-confirm js-edit-blob gl-ml-3 " data-track-event="click_edit" data-track-label="Edit" href="/adm_uweichert/iostat-prtg/-/edit/master/iostat-parse.sh">Edit</a><a class="btn gl-button btn-confirm ide-edit-button gl-ml-3 btn-inverted" data-track-event="click_edit_ide" data-track-label="Web IDE" data-track-property="secondary" href="/-/ide/project/adm_uweichert/iostat-prtg/edit/master/-/iostat-parse.sh">Web IDE</a><div class="btn-group gl-ml-3" role="group">
...
<button class="btn btn gl-button btn-default btn-icon js-copy-blob-source-btn" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="btn gl-button btn-default btn-icon js-copy-blob-source-btn" data-title="Copy file contents" data-clipboard-target=".blob-content[data-blob-id=&#39;4d9159a193079667113e750b32002b163ea9cdfc&#39;] &gt; pre" type="button" title="Copy file contents" aria-label="Copy file contents"><svg class="s16" data-testid="copy-to-clipboard-icon"><use xlink:href="/assets/icons-a53822592d2fb2cd30ac129d53a7440a8aa3ffcd0bd43075602941d95b629b76.svg#copy-to-clipboard"></use></svg></button>
<a class="btn gl-button btn-default btn-icon has-tooltip" target="_blank" rel="noopener noreferrer" aria-label="Open raw" title="Open raw" data-container="body" href="/adm_uweichert/iostat-prtg/-/raw/master/iostat-parse.sh"><svg class="s16" data-testid="doc-code-icon"><use xlink:href="/assets/icons-a53822592d2fb2cd30ac129d53a7440a8aa3ffcd0bd43075602941d95b629b76.svg#doc-code"></use></svg></a>
<a download="iostat-parse.sh" class="btn gl-button btn-default btn-icon has-tooltip" target="_blank" rel="noopener noreferrer" aria-label="Download" title="Download" data-container="body" href="/adm_uweichert/iostat-prtg/-/raw/master/iostat-parse.sh?inline=false"><svg class="s16" data-testid="download-icon"><use xlink:href="/assets/icons-a53822592d2fb2cd30ac129d53a7440a8aa3ffcd0bd43075602941d95b629b76.svg#download"></use></svg></a>
...
<a class="js-fork-suggestion-button gl-button btn btn-grouped btn-inverted btn-success" rel="nofollow" data-method="post" href="/adm_uweichert/iostat-prtg/-/blob/master/iostat-parse.sh">Fork</a>
...
<div class="blob-viewer" data-path="iostat-parse.sh" data-type="simple" data-url="/adm_uweichert/iostat-prtg/-/blob/master/iostat-parse.sh?format=json&amp;viewer=simple">
...
<h3 class="page-title">Delete iostat-parse.sh</h3>
<button aria-label="Close" class="close" data-dismiss="modal" type="button">
<span aria-hidden>&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-delete-blob-form js-quick-submit js-requires-input" action="/adm_uweichert/iostat-prtg/-/blob/master/iostat-parse.sh" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="delete" /><input type="hidden" name="authenticity_token" value="mA8moXU00w9JC0puz3HHrrLnxDBKLYT10ODm4jBxvonL8eYcMHEV/m1xwM1spPKsN0xiXioBs3dkfcSGXi44Ig==" /><div class="form-group row commit_message-group">
<label class="col-form-label col-sm-2" for="commit_message-a54323d4250e62930223bca77d1e80d5">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-a54323d4250e62930223bca77d1e80d5" class="form-control gl-form-input js-commit-message" placeholder="Delete iostat-parse.sh" required="required" rows="3">
Delete iostat-parse.sh</textarea>
</div>
</div>
</div>
...
<input type="checkbox" name="create_merge_request" id="create_merge_request-059b3a8f8eda2b8bb80b71fbf2ad027b" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-059b3a8f8eda2b8bb80b71fbf2ad027b">Start a <strong>new merge request</strong> with these changes
</label></div>
...
<div class="modal-content">
<div class="modal-header">
<h3 class="page-title">Replace iostat-parse.sh</h3>
<button aria-label="Close" class="close" data-dismiss="modal" type="button">
<span aria-hidden>&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-quick-submit js-upload-blob-form" data-method="put" action="/adm_uweichert/iostat-prtg/-/update/master/iostat-parse.sh" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="put" /><input type="hidden" name="authenticity_token" value="sZ1eTO92Y+MXcCBHlvGZfeOMH9I5KAcELLQRjhfAS9ziY57xqjOlEjMKquQ1JKx/Zie5vFkEMIaYKTPqeZ/Ndw==" /><div class="dropzone">
...
<label class="col-form-label col-sm-2" for="commit_message-ad407d433a2ce87a27d896ac82a13586">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-ad407d433a2ce87a27d896ac82a13586" class="form-control gl-form-input js-commit-message" placeholder="Replace iostat-parse.sh" required="required" rows="3">
Replace iostat-parse.sh</textarea>
</div>
</div>
</div>
...
<div class="js-create-merge-request-container">
<div class="form-check gl-mt-3">
<input type="checkbox" name="create_merge_request" id="create_merge_request-6567cc3a692a7cb52d7a9647a31d0e34" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-6567cc3a692a7cb52d7a9647a31d0e34">Start a <strong>new merge request</strong> with these changes
</label></div>
